# 🤖 Créer son propre Bot Facebook Messenger (2016)

![Alt text](https://github.com/2dpodcast/messenger-bot-tutorial/blob/master/demo/Demo.gif)
...
1. Create or configure a Facebook App or Page here https://developers.facebook.com/apps/
    ...
    ![Alt text](https://raw.githubusercontent.com/2dpodcast/messenger-bot-tutorial/master/demo/shot1.jpg)
...
2. In the app go to Messenger tab then click Setup Webhook. Here you will put in the URL of your Heroku server and a token. Make sure to check all the subscription fields. 
    ...
    ![Alt text](https://raw.githubusercontent.com/2dpodcast/messenger-bot-tutorial/master/demo/shot3.jpg)

3. Get a Page Access Token and save this somewhere. 

    ![Alt text](https://raw.githubusercontent.com/2dpodcast/messenger-bot-tutorial/master/demo/shot2.jpg)
...
1. Add an API endpoint to index.js to process messages. Remember to also include the token we got earlier. 
    ...
    **Optional, but recommended**: keep your app secrets out of version control!
    ...
    ![Alt text](https://raw.githubusercontent.com/2dpodcast/messenger-bot-tutorial/master/demo/config_vars.jpg)
    ```bash
...
![Alt text](https://raw.githubusercontent.com/2dpodcast/messenger-bot-tutorial/master/demo/shot4.jpg)
...
![Alt text](https://raw.githubusercontent.com/2dpodcast/messenger-bot-tutorial/master/demo/shot5.jpg)
...
Now when you chat with the bot and type 'Generic' you can see this.
   ...
   ![Alt text](https://raw.githubusercontent.com/2dpodcast/messenger-bot-tutorial/master/demo/shot6.jpg)
